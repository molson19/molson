...
In the average and worst cases, these algorithms are all O(n^2), which if you check out the time complecomplexity curves below, is not very good. 

![Big-O Complexity Curves](https://mattjmatthias.co/articles/dev-training-big-o-notation#&gid=1&pid=1)
